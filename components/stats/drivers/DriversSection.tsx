    ...
    <div className="space-y-6">
      ...
      {!driver ? (
        ...
        <div className="space-y-8">
          {profile.starts === 0 && profile.entries > 0 && (
            <div className="flex items-start gap-2.5 rounded-[2px] border border-status-info/40 bg-status-info/5 px-4 py-3">
              <svg
              ...
              <p className="text-sm text-ink-2">
                {t("driversTab.dnsOnlyNote", { entries: profile.entries })}
              </p>
            </div>
          )}
          <SnapshotSection

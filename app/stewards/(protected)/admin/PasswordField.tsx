    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          required
          className="w-full rounded-lg border border-white/15 bg-black/30 px-3 py-2 pr-16 text-sm text-white/90 focus:border-[#D4AF37]/50 focus:outline-none transition"
        />
        <button
          type="button"
          onClick={() => setShow((v) => !v)}
